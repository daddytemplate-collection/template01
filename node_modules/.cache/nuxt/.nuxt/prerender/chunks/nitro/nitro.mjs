import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getRequestProtocol, getRequestHost, setHeader, getHeader, getQuery as getQuery$1, getRouterParam, getResponseStatus, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, withBase, withTrailingSlash, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/unstorage/drivers/fs.mjs';
import crypto from 'node:crypto';
import fsDriver from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/radix3/dist/index.mjs';
import { toValue } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1, isAbsolute } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/pathe/dist/index.mjs';
import { createConsola } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/consola/dist/index.mjs';
import { XMLParser } from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/fast-xml-parser/src/fxp.js';
import localAdapter from 'file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/zhuenxi/Documents/trae_projects/yunnanjia/server/assets"}];
...
const _47Users_47zhuenxi_47Documents_47trae_projects_47yunnanjia_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('internal:nuxt:prerender', _47Users_47zhuenxi_47Documents_47trae_projects_47yunnanjia_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/.cache/nuxt/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zhuenxi/Documents/trae_projects/yunnanjia","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/zhuenxi/Documents/trae_projects/yunnanjia/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/.cache/nuxt/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/.cache/nuxt/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9b731104-fa55-4a26-82e2-02630d40c035",
  ...
  "emailUser": "598082463@qq.com",
  "emailPass": "orexzhykkykabdhc",
  "sitemap": {
    "isI18nMapped": false,
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/zhuenxi/Documents/trae_projects/yunnanjia/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-site-config": {
...
const _vlc5rYkbVKy0_LzVAVgZLY_tawghAqPFttnIeiFtCWY = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _vlc5rYkbVKy0_LzVAVgZLY_tawghAqPFttnIeiFtCWY
];
...
const _xiedoR = eventHandler((event) => {
...
const _FCc6Zm = eventHandler(async (e) => {
...
const _gfmpUs = defineEventHandler(async (e) => {
  const collections = [];
...
const _a4rb40 = defineEventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///Users/zhuenxi/Documents/trae_projects/yunnanjia/node_modules/fast-xml-parser/src/fxp.js');
...
const _FF9tPi = defineEventHandler(sitemapXmlEventHandler);

const _2lVrtI = eventHandler(async (event) => {
...
const _oHE9tW = eventHandler(async (event) => {
...
const _lazy_eoxYNO = () => import('../routes/api/captcha.get.mjs');
const _lazy_DQJPsO = () => import('../routes/api/submit.post.mjs');
const _lazy_gjflx1 = () => import('../_/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _xiedoR, lazy: false, middleware: true, method: undefined },
  { route: '/api/captcha', handler: _lazy_eoxYNO, lazy: true, middleware: false, method: "get" },
  { route: '/api/submit', handler: _lazy_DQJPsO, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _FCc6Zm, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _gfmpUs, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _a4rb40, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _FF9tPi, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _2lVrtI, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _2lVrtI, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _oHE9tW, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _oHE9tW, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_gjflx1, lazy: true, middleware: false, method: undefined }
];
