        ...
        <div class="container mx-auto px-4 pt-16 pb-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="flex flex-col space-y-4">
                        <li v-for="(item, index) in companyLinks" :key="index">
                            <NuxtLink :to="item.href" class="text-gray-500 hover:text-[#001151] hover:underline underline-offset-4 transition-all duration-200">
                                {{ item.label }}
                            </NuxtLink>
                        </li>
                    </ul>
                ...
                <div class="lg:col-span-4">
                    ...
                    <ul class="flex flex-col space-y-6">
                        ...
                        <li class="flex items-start gap-4">
                            <div class="mt-1 flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-blue-50 text-[#001151]">
                                <Phone class="w-4 h-4" />
                            </div>
                            <div>
                                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">Phone</p>
                                <a :href="`tel:${siteConfig?.base?.phone}`" class="text-gray-700 font-medium hover:text-[#001151] transition-colors">
                        ...
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a :href="`mailto:${siteConfig?.base?.email}`" class="text-gray-700 font-medium hover:text-[#001151] transition-colors">
                        ...
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">Head Office</p>
            ...
            <div class="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="text-gray-500 text-sm">
                    &copy; {{ new Date().getFullYear() }} <span class="font-semibold text-gray-900">{{ siteConfig?.base?.companyName || 'Company' }}</span>. All rights reserved.
                </div>
                ...
                <div class="flex items-center gap-4 text-sm">
                    ...
                    <a href="https://www.daddytemplate.com" target="_blank" class="text-gray-400 hover:text-gray-800 transition-colors">
